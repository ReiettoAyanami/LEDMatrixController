...
class Image_Button(Button):
    ...
    def __init__(self, rect,image, outline_colors = (255,255,255,255), show_shadow = False, shadow_size = 20, shadow_color = [0,0,0,10], border_radius = 0.4, outline_thickness =  1) -> None:
        ...
        if self.outline_thickness:
            ...
            self.self.outline_thickness = self.outline_thickness
            self.outline_surface = pygame.Surface((self.rect.w + self.outline_thickness * 2, self.rect.h + self.outline_thickness * 2), pygame.SRCALPHA)
            gradient_aaroundedrectangle(self.outline_surface, (0,0,self.rect.w + self.outline_thickness * 2, self.rect.h + self.outline_thickness * 2), self.outline_colors, border_r= border_radius)
    ...
    def show(self, surface):
        ...
        if self.self.outline_thickness:
            self.outline_colors = self.outline_colors
            self.self.outline_thickness = self.self.outline_thickness
            self.outline_surface = pygame.Surface((self.rect.w + self.outline_thickness * 2, self.rect.h + self.outline_thickness * 2), pygame.SRCALPHA)
            gradient_aaroundedrectangle(self.outline_surface, (0,0,self.rect.w + self.outline_thickness * 2, self.rect.h + self.outline_thickness * 2), self.outline_colors, border_r= self.border_r)
        ...
        surface.blit(self.outline_surface, (self.rect.x - self.self.outline_thickness,self.rect.y - self.self.outline_thickness))
